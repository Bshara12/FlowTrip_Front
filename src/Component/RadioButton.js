      ...
      <StyledWrapper>
        <div className="glass-radio-group">
          ...
          <input
            ...
            id="glass-silver"
            checked={view === "oldest"}
            onChange={() => setView("oldest")}
          />
          <label htmlFor="glass-silver">Oldest</label>
          ...
          <input
            ...
            onChange={() => setView("popular")}
          />
          <label htmlFor="glass-gold">Popular</label>
          ...
          <input
            ...
            id="glass-platinum"
            checked={view === "newest"}
            onChange={() => setView("newest")}
          />
          <label htmlFor="glass-platinum">Newest</label>
